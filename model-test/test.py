...
class MTCase(unittest.TestCase):
    ...
    def test_check_arg(self):
        ...
        self.assertEqual(model_test.check_arg(), "-m eye")
    ...
    def test_get_rs(self):
        ...
        self.assertTrue(model_test.get_rs('eye', '/Users/apple/digital-phenotyping/self-report/'), rs_list_eye)
        self.assertTrue(model_test.get_rs('hair', '/Users/apple/digital-phenotyping/self-report/'), rs_list_hair)
